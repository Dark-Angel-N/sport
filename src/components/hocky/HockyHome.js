  ...
  return (
    <div className=''>
      <div className='flex items-center gap-2 text-sm text-black/50 pt-3 mb-4'>
        ...
        <IoIosArrowForward />
        <a href="#" className='text-black/50'><span>Hocky</span></a>
      </div>
      <HomeBanner />
        ...
        <div className='col-xl-10 col-md-9'>
          <div className="row gy-4">
                  ...
                  ['1', '2', '3', '4', '5'].map((index) => {
                    return (
                      <div class='item relative'>
                        <img src="/assets/images/svg/banner11.png" alt="banner" className='rounded-[10px]' />
            ...
            <div className="col-xl-5">
              <iframe width="100%" height="280" className='rounded-[10px]' src="https://www.youtube.com/embed/r6f6zgBZ-SM?si=nhmVmjHWn2UZApU0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        ...
        <div className="col-9">
          ...
          <div className='flex rounded-lg relative overflow-hidden mt-4'>
            ...
            <div className="row">
              ...
              <div className="col-5">
                <img src="https://img.olympics.com/images/image/private/t_social_share_thumb/f_auto/primary/b2unl1gppjiic0fld0em" alt="banner" className='w-full h-full object-cover' />
              </div>
            </div>
          </div>
