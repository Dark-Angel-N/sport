        ...
        <section>
            ...
            <div className='container'>
                <div className='flex items-center gap-2 text-sm text-black/50 pt-3'>
                    ...
                    <IoIosArrowForward />
                    <span>MLS 2023-24</span>
                </div>
                <div className='my-4'>
                    <div className='bg-[#0033A0] p-5 text-white rounded-lg'>
                        <h1 className="text-[28px] mb-4">MLS 2023-24</h1>
                        <p className='mb-0'>26 Feb 2022 - 9 Oct 2022</p>
                    </div>
                </div>
                <div className='my-4'>
                            ...
                            <div className='rounded-[6px] mb-4 overflow-hidden shadow-[0px_4px_8.4px_#0000001A]'>
                                <div>
                                    <div className="text-[#464646] bg-[#EBF2FF] d-flex gap-1 justify-between items-center px-3 py-3 border-b">
                                        <span>About MLS 2023-24</span>
                                    </div>
                                    <div className='p-4'>
                                        <h1 className="text-[20px] mb-3">Major League Soccer (MLS 2022)</h1>
                                        <img src="/assets/images/png/throfy.avif" alt="throfy" />
                                        <p className='text-black/50 mt-4'>The MLS is one of the fastest-growing leagues in America despite heavy competition from the NHL, NFL, and whatnot. With the league attracting hordes of European stars to the United States, interest in football (or soccer as it is known in these parts) has peaked over the past few years. What was previously perceived as a ‘retirement home’ for global superstars to wind down their careers is now playing host to multitudes of big-name players in their primes on a week in week out basis. Let us take a closer look at what MLS really is.</p>

                                        <h1 className='text-xl'>1. MLS Format</h1>
                                        <p className='text-black/50 mt-4'>The MLS comprises of 24 teams, 21 from the United States and 3 from Canada, each of whom are subsequently congregated into the Eastern and Western conferences depending upon their locations. Each team in the league tallies 34 games over the course of a season that runs from March to October.</p>
                                        <p className='text-black/50'>Every team from a particular conference engages in battle with its fellow members twice, once at home and once away, totaling 24 games. Also, every team plays one game against a team from the opposite conference adding 10 more games to the already present total of 24.</p>
                                        <img src="https://staticg.sportskeeda.com/editor/2019/08/d40ed-15656122199852-800.jpg" alt="img" />
                                    </div>
                                </div>
                            </div>
