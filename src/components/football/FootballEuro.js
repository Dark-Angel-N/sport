            ...
            <div className='container'>
                ...
                <div className='my-4'>
                    <div className='bg-[#0033A0] p-5 text-white rounded-lg'>
                        <h1 className="text-[28px] mb-4">Euro 2024</h1>
                                ...
                                <div className="col-xl-7 news_slider">
                                    <div class='item relative h-full'>
                                        ...
                                        <div className='absolute bottom-10 px-4'>
                                            <a  href='/internal-page' className='block mb-2 hover:!underline text-white text-lg'>Au Revoir Football? Paul Pogba switches career to Silver Screen amid Ban, makes debut in French movie</a>
