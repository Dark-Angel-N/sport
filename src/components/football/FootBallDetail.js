...
const FootBallDetail = () => {
    ...
    return (
        <div className='pt-4'>
            <div className='row'>
                <div className='col-8'>
                    <h1 className='mb-4 lg:text-[36px] md:text-[30px] text-[20px]'>Barcleona Transfer News Roundup: Catalans urged to sign German ace,club not eyeing Mohamed Salah, and more - November 30, 2024</h1>
                    ...
                    <p className='text-lg text-black'>Barcelona are set to welcome  Las Palmas at the Estani Olimpic Lluis Company on  Saturady( November 30) in Laliga.The Catalans are leading the title race after 14 games with 34 points.</p>
                            ...
                            <div className='bg-[#F3F8FB] p-3 d-md-flex items-center justify-between'>
                                <div className='flex items-center gap-3'>
                                    ...
                                    <div className='d-flex flex-wrap items-center sm:gap-3 gap-2'>
                                        <p className='mb-0'>By <span className='text-[#D32F2F]'>Bruce Marlow</span></p>
                                        <p className='mb-0'>Modified Nov 30,2024 0:4:57 GMT</p>
                                    </div>
                                </div>
                                <div className='flex items-center justify-end gap-3 mt-sm-0 mt-3'>
                                    {/* <div className='w-[50px] h-[50px] bg-white rounded-full flex items-center justify-center text-xl'><FaRegMessage /></div> */}
                    ...
                    <div className='row'>
                        <div className='col-12'>
                            ...
                            <div className="relative">
                                <img src="/assets/images/svg/banner18.png" alt="banner" className='rounded-[10px]' />
            ...
            <div className='row'>
                <div className="col-8 mt-3">
                    <iframe width="100%" height="400" className='rounded-[10px]' src="https://www.youtube.com/embed/oOjVlrDOG-Y?si=dMhdSe1w0LP6ucVf" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    ...
                    <div className='bg-[#E8E8E8]/50 mt-3 p-3 rounded d-flex items-center gap-3'>
                        <div>
                            ...
                            <a href='/internal-page' className='text-black hover:!underline block font-[600] my-3'>“You will see Sarfaraz playing” -Aakash Chopra backs youngster to play ahead of KL Rahul for 2nd ahead of KL Rahul</a>
            ...
            {/* 
            <div class="bg-[#E8E8E8]/40 py-4 text-[#0000A7]/60 text-start lg:text-2xl sm:text-xl lg:px-[200px] md:px-[80px] sm:px-[40px] px-[16px] mb-4 mt-md-0 mt-4">“Stiller would be good for Barca because of his style of play. I trust him and if Barcelona were to sell,his signing wold be possible and sensible,” Mattaus said.</div> */}
            ...
            {/* <div className='mt-5'>
                <h1 className='text-[24px] border-b mb-2 pb-2'>Comments</h1>
                <p>Commenting as a <span className='text-black/50'>Guest</span></p>

                <div className='flex items-center gap-3'>
                    <img src="/assets/images/svg/user.svg" alt="user" className='w-[50px] h-[50px] rounded-full' />
                    <div className='border-[1px] border-black/20 rounded py-3 my-3 px-3 w-full flex items-center justify-between'>
                        <input type="text" placeholder='Be the first to comment......' className='placeholder:text-sm' />
                        <div className='flex items-center gap-3 text-black/50 text-lg'>
                            <FaRegFaceSmile />
                            <FiCamera />
                            <HiOutlineGif />
                        </div>
                ...
                <div className='my-4'>
                    <div className='w-[100px] h-[100px] bg-[#D9D9D9] rounded-full flex items-center justify-center mx-auto'>
                        <img src="/assets/images/svg/message.svg" alt="message" />
                    </div>
                    <p className='text-center mt-4'>No one seems to have shared their thoughts on this topic yet</p>
                    <p className='text-black/50 text-center'>Leave a comment so your voice will be heared first.</p>
                </div>

                <div className='border-t pt-3 mb-4 d-sm-flex items-center justify-between'>
                    <div className='flex items-center justify-center gap-2 text-black/50'>
                        Powered
                        <img src="/assets/images/logo.svg" alt="logo" className='w-[100px]' />
                    </div>
