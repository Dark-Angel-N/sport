        ...
        <section>
            ...
            <div className='container'>
                <div className='flex items-center gap-2 text-sm text-black/50 pt-3'>
                    ...
                    <IoIosArrowForward />
                    <span>UEFA Champions League 2024-25</span>
                </div>
                <div className='my-4'>
                    <div className='bg-[#0033A0] p-5 text-white rounded-lg'>
                        <h1 className="text-[28px] mb-4">UEFA Champions League 2024-25</h1>
                        <p className='mb-0'>9 Jul 2024 - 31 May 2025</p>
                    </div>
                </div>
                <div className='my-4'>
...
export default FootballChampions