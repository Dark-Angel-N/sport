            ...
            <div className='container'>
                ...
                <div className='my-4'>
                    <div className='bg-[#0033A0] p-5 text-white rounded-lg'>
                        <h1 className="text-[28px] mb-4">La Liga 2024-25</h1>
                            ...
                            <div className='rounded-[6px] mb-4 overflow-hidden shadow-[0px_4px_8.4px_#0000001A]'>
                                <div>
                                    <div className="text-[#464646] bg-[#EBF2FF] d-flex gap-1 justify-between items-center px-3 py-3 border-b">
                                        <span>About La Liga 2024-25</span>
                                    </div>
                                    <div className='p-4'>
                                        <h1 className="text-[20px] mb-3">UEFA Nations League</h1>
                                        <p className='text-black/50'>Follow all the Latest La Liga Updates, La Liga news, La Liga live scores, previews, reviews and transfer updates</p>
                                        <p className='text-black/50'>La Liga or La Liga Santander is the top-flight of the Spanish football league system. 20 teams battle it out every year and the 3 lowest ranked teams at the end of the season will be relegated to the Segunda division and replaced by the top 3 teams of that division.</p>
                                        <p className='text-black/50'>The La Liga was founded in 1929 and 62 different teams have featured in the league over the years. As per UEFA, La Liga has been the top league in Europe for the past five years.</p>

                                        <h1 className="text-[20px] mb-3">La Liga - Record Winners</h1>
                                        <img src="/assets/images/png/chart.avif" alt="nation" className='rounded-lg' />
