        ...
        <section>
            ...
            <div className='container'>
                <div className='flex items-center gap-2 text-sm text-black/50 pt-3'>
                    ...
                    <IoIosArrowForward />
                    <span>UEFA Nations League 2024-25</span>
                </div>
                <div className='my-4'>
                    <div className='bg-[#0033A0] p-5 text-white rounded-lg'>
                        <h1 className="text-[28px] mb-4">UEFA Nations League 2024-25</h1>
                        <p className='mb-0'>5 Sep 2024 - 8 Jun 2025</p>
                    </div>
                </div>
                <div className='my-4'>
                            ...
                            <div className='rounded-[6px] mb-4 overflow-hidden shadow-[0px_4px_8.4px_#0000001A]'>
                                <div>
                                    <div className="text-[#464646] bg-[#EBF2FF] d-flex gap-1 justify-between items-center px-3 py-3 border-b">
                                        <span>About UEFA Nations League</span>
                                    </div>
                                    <div className='p-4'>
                                        <h1 className="text-[20px] mb-3">UEFA Nations League</h1>
                                        <p className='text-black/50'>The UEFA Nations League is a biennial international football competition orchestrated by UEFA, the sport&apos;s European governing body. The contestants of the league mainly includes senior men&apos;s national team from Europe. The league was first started in 2018, just after the world cup and it came to an end in 2019 at Portugal.</p>
                                        <img src="/assets/images/png/nation.avif" alt="nation" className='rounded-lg' />
...
export default FootballNations