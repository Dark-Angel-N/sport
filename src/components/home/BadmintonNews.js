    ...
    return (
        <div className='pb-5'>
            <div className='d-flex items-center gap-3 mb-4'>
                <h1 className='md:text-[28px] text-[24px] mb-0'>Badminton</h1>
            </div>
                    ...
                    <div className='col-xl-10 col-md-9'>
                        <div className="row gy-4">
                                        ...
                                        ['1', '2', '3', '4', '5'].map((index) => {
                                            return (
                                                <div class='item relative'>
                                                    <img src="/assets/images/svg/banner13.png" alt="banner" className='rounded-[10px]' />
                            ...
                            <div className="col-xl-5">
                                <iframe width="100%" height="280" className='rounded-[10px]' src="https://www.youtube.com/embed/klAbKqpTHpo?si=GcUZC9sfssQSYNDi" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                            ...
                            <div className='col-12 text-center border-b'>
                                <button className="bg-[#0033A0] mb-4 text-white rounded py-2 px-[20px]">Read More</button>
                            </div>
                        </div>
                    </div>
