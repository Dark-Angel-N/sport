        ...
        <section>
            ...
            <div className='container'>
                <div className='flex items-center gap-2 text-sm text-black/50 pt-3'>
                    ...
                    <IoIosArrowForward />
                    <span>Vijay Hazare</span>
                </div>
                <div className='my-4'>
                    <div className='bg-[#0033A0] p-5 text-white rounded-lg'>
                        <h1 className="text-[28px] mb-4">Vijay Hazare Trophy 2024</h1>
                        <p className='mb-0'>21 Dec 2024 - 18 Jan 2025</p>
                    </div>
                </div>
                ...
                <div className='row'>
                    <div className='col-8'>
                        <div class='item relative mb-4'>
                            <h1 className="text-2xl mb-4">Karun Nair breaks massive List A record with latest hundred in Vijay Hazare Trophy 2024-25</h1>
