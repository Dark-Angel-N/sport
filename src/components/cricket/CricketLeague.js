            ...
            <div className='container'>
                ...
                <div className='my-4'>
                    <div className='bg-[#0033A0] p-5 text-white rounded-lg'>
                        <h1 className="text-[28px] mb-4">SA20 League</h1>
                        <p className='mb-0'>9 Jan 2025 - 8 Feb 2025</p>
                    </div>
                </div>
                ...
                <div className='row'>
                    <div className='col-8'>
                        <div class='item relative mb-4'>
                            <h1 className="text-2xl mb-4">&quot;South Africa have found a gem, and they need to protect him&quot; - Dinesh Karthik on young South African pacer</h1>
                        ...
                        <p className='text-black/60 text-justify mb-0 pb-4'>Defending Champions Haryana will be relying on Rahul Tewatia, Harshal Patel, Aman Kumar and Anshul Kamboj to carrying the form from the last season.</p>
